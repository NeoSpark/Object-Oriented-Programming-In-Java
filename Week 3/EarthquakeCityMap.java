...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
	    ...
	    for(PointFeature pointF: earthquakes) {
	    	markers.add(createMarker(pointF));
	    }
	...
	*/
	...
	{	
		...
		textSize(20);
		fill(0,0,0,200);
		text("Earthquake key",35,70);
		
		
		fill(color(255,0,0));
		ellipse(30,120,18,18);
		fill(0);
		textSize(11);
		text("5.0 + magnitude",50,120);
		
		fill(color(255,255,0));
		ellipse(30,170,13,13);
		fill(0);
		textSize(11);
		text("4.0 + magnitude",50,170);
		
		fill(color(0,0,255));
		ellipse(30,220,10,10);
		fill(0);
		textSize(11);
		text("Below 4.0 + magnitude",50,220);
	}
}
